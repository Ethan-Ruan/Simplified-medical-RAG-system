...
# Data Configuration
DATA_FILE ="C:/Users\Ethan Ruan\Desktop\exp04-easy-rag-system\milvus_data\processed_data.json"
...
# 新增配置参数（假设文件已存在）
USE_RERANKER = True  # 是否启用重新排序功能
RERANKER_MODEL = "cross-encoder/ms-marco-MiniLM-L-6-v2"  # 轻量级重排序模型
